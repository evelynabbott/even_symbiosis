...
input="GO_D.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).

#Choose "amil" for host OR "c_and_d" for symbionts
...
gomwuStats(input, goDatabase, goAnnotations, goDivision,
           ...
           #Module=TRUE # un-remark this if you ar  e analyzing an UNSIGNED WGCNA module 
)
